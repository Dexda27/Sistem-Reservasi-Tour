...
(function () {
  ...
  */
  ...
  // --------------------------------------------------------------------
    ...
    profitLastMonthConfig = {
      ...
      series: [
        {
          name: 'Jan',
          data: [0, 2, 80, 10, 5, 25, 35, 0, 14, 15, 95, 5,10,16,22,0, 2, 80, 10, 5, 25, 35, 0, 14, 15, 95, 5,10,16,22]
        // },
        // {
        //   name: 'Feb',
        //   data: [25, 10, 40, 25, 55, 25,0, 25, 10, 40, 25, 55, 25, 10, 40, 25, 55, 25, 40, 25, 55, 25, 10, 40, 25, 55, 25]
        }
      ],
      tooltip: {
        shared: false,
      ...
      xaxis: {
        categories: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12','13','14','15','01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12','13','14','15'],
        title: {
          text: 'Month'
        },
        labels: {
  ...
  // --------------------------------------------------------------------
    ...
    // // Menyiapkan data untuk grafik
    // var labels = allDates;
    // var data = dataMap.map(function(data) {
    //   return data; 
    // });
    console.log(dataMap)
